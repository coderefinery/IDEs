...
now we could try making the code do something... why not printing a surprising "Hello whatever message!". Replace autogenerated stub **_pass_** line with **_print("Hello World!")_**. While typing **_print_** command, stop, so it would look like:
...
<table style="width:100%;"> 
  ...
  <tr>
    <td style="text-align: center; border: 1px solid black; padding: 3px;"> Goto Line </td>
